...
namespace SlackTube.Api.Data.Migrations
{
    ...
    [Migration("20260608122138_AddUploadKidsAndSyntheticFlags")]
    partial class AddUploadKidsAndSyntheticFlags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SlackTube.Api.Domain.AppSettings", b =>
                {
                    ...
                    b.Property<bool>("ContainsSyntheticMedia")
                    ...
                    b.Property<int>("TransferChunkSizeMb")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SlackTube.Api.Domain.GoogleOAuthClient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("google_oauth_clients", (string)null);
                });
            ...
            modelBuilder.Entity("SlackTube.Api.Domain.GoogleAccount", b =>
                {
                    b.HasOne("SlackTube.Api.Domain.GoogleOAuthClient", "OAuthClient")
                        .WithMany()
